...
Seeds the database with sample data for all banks
"""
...
def seed_kpis(bank_id: str, days: int = 90):
    ...
    metrics = [
        ...
        "total_deposits", "total_loans", "transaction_volume",
        "transaction_count", "mobile_banking_users",
        "atm_transactions", "branch_visits"
    ]
